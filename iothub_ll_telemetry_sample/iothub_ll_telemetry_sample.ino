...
static void run_demo()
{
  ...
  char str_array[80];
  //str.toCharArray(str_array, message.length());
  //strcpy(str_array, message.c_str());
...
//            Serial.println(inString);
            ...
            //char str_array[content.length()];
            //content = "";
            //strcpy(str_array, content.c_str());
            //const char* string1 = content.c_str();
            //delay(1000);
        ...
        if (messages_sent < MESSAGE_COUNT)
        {
            ...
            sprintf(telemetry_msg_buffer, "%d", inString.toInt());
